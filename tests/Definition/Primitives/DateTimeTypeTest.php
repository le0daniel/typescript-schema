...
class DateTimeTypeTest extends TestCase
{
    public function testsReturnsInstanceOfDateTimeImmutable(): void
    {
        ...
        self::assertInstanceOf(DateTimeImmutable::class, $type->parse('2023-12-29 18:56:01', new Context()));
        self::assertSame('2023-12-29 18:56:01', $type->parse('2023-12-29 18:56:01', new Context())->format('Y-m-d H:i:s'));
    }
    ...
    public function testSerialize()
    {
        self::assertSame(
            ...
            DateTimeType::make('Y-m-d H:i:s')
                ->parse('2023-12-29 18:56:01', new Context())
                ->format('Y-m-d H:i:s')
        );

        self::assertSame(
            Value::INVALID,
            DateTimeType::make()->parse('2023-12-29 18:56:01', new Context())
        );
    }
    ...
    public function testBefore()
    {
        ...
        self::assertSame(Value::INVALID,
            $type->parse('2023-12-29 18:56:01', new Context()),
        );

        self::assertInstanceOf(DateTimeImmutable::class, $type->parse('2023-12-29 18:56:00', new Context()));
    }
    ...
    public function testAfter()
    {
        ...
        self::assertInstanceOf(DateTimeImmutable::class, $type->parse('2023-12-29 18:56:02', new Context()));
    }
